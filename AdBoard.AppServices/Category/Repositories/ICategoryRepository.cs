...
public interface ICategoryRepository : IGenericRepository<CategoryEntity, long>
{
    ...
    /// <returns>Список хлебных крошек в виде <see cref="CategoryLightDTO"/> от корневой категории к целевой.</returns>
    Task<List<CategoryEntity>> GetBreadcrumbsByIdAsync(long id, CancellationToken cancellationToken);
